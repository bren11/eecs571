...
link
set_wire_load_model -name $WIRE_LOAD -lib $LOGICLIB $DesignName
set_wire_load_mode top

#---- All constraints are listed below ----#
set clk_period 125.0
...
set_input_delay 2.4 -max -clock $clk_name \
  [remove_from_collection [all_inputs] [get_ports clk]]
set_output_delay 2.4 -max -clock $clk_name [all_outputs]
...
set_driving_cell -lib_cell dffacs1 -no_design_rule \
  [remove_from_collection [all_inputs] [get_ports clk]]
